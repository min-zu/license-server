...
export default function AdminPage() {
  ...
  const columnDefs: ColDef<Admin>[] = [
    ...
    {
      field: 'role', headerName: '데모 관리자', headerClass: 'header-style', cellClass: 'cell-style',
      cellRenderer: (params: ICellRendererParams<Admin>) => (
        params.value === 4 ? <CheckBox fontSize="small" style={{ color: 'gray'}}/> : <CheckBoxOutlineBlank fontSize="small" style={{ color: 'gray'}}/>
      ),
    },
